...
public:
  ...
  enum {
    RuleBasic_types = 0, RuleType_identifier = 1, RuleGeneric_specifier = 2, 
    RuleType_specifier = 3, RuleBasic_declaration = 4, RuleInited_declaration = 5, 
    RuleUninited_declaration = 6, RuleDeclaration = 7, RuleStruct_specifier = 8, 
    RuleStruct_generic_parameter = 9, RuleStruct_generic_argument = 10, 
    RuleStruct_generic_argument_list = 11, RuleStruct_generic_arguments = 12, 
    RuleStruct_generic_parameter_list = 13, RuleStruct_generic_parameters = 14, 
    RuleFunction_specifier = 15, RuleFunction_parameter = 16, RuleFunction_parameter_list = 17, 
    RuleFunction_parameters = 18, RuleLiteral_value = 19, RuleValue = 20, 
    RuleFunction_call = 21, RuleCall_operator = 22, RuleCall_parameters = 23, 
    RuleBasic_value = 24, RuleValue_visitor = 25, RuleExpr = 26, RuleFormular = 27, 
    RuleComparation = 28, RuleSum = 29, RuleTerm = 30, RuleConditional = 31, 
    RuleConditional_elseif = 32, RuleConditional_else = 33
  };
